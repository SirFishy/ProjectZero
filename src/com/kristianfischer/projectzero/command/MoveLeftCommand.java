...
public class MoveLeftCommand extends Command {
    ...
    public void execute(GameObject object) {
        if(object.getGameId().equals(GameId.PLAYER)) {
            object.getMovementComponent().move(MovementComponent.MovementDirection.LEFT);
        }
    }
    ...
    public void stop(GameObject object) {
        if(object.getGameId().equals(GameId.PLAYER)) {
           object.getMovementComponent().stopMoving(MovementComponent.MovementDirection.LEFT);
        }
    }
}
