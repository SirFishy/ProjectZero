...
public class MoveRightCommand extends Command {
    ...
    public void execute(GameObject object) {
        if(object.getGameId().equals(GameId.Player)) {
            ((Player) object).getPlayerMovementHandler().movePlayer(PlayerMovementHandler.MovementDirection.RIGHT);
        }
    }
    ...
    public void stop(GameObject object) {
        if(object.getGameId().equals(GameId.Player)) {
            ((Player) object).getPlayerMovementHandler().stopPlayer(PlayerMovementHandler.MovementDirection.RIGHT);
        }
    }
}
